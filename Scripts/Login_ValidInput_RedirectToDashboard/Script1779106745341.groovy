...
// Access test website via browser
WebUI.openBrowser(null)
WebUI.navigateToUrl('https://opensource-demo.orangehrmlive.com/web/index.php/auth/login')

// Validate if correct page
WebUI.waitForElementPresent(findTestObject('Object Repository/login_page/lbl_loginTitle'), 0)
WebUI.verifyElementPresent(findTestObject('Object Repository/login_page/lbl_loginTitle'), 0)
